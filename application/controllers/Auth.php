...
class Auth extends CI_Controller
{
	...
	public function index()
	{
		...
		else
		{
			...
			//$content = $this->_render_page('auth' . DIRECTORY_SEPARATOR . 'index', $this->data,true);
		}
	}
	...
	public function change_password()
	{
		...
		if ($this->form_validation->run() === FALSE)
		{
			...
			// render
			$data['content']=$this->load->view('mainmenu',"",true);
			$data['content'].=$this->load->view('auth/change_password',$this->data,true);
			$this->load->view('default',$data);
	...
	public function forgot_password()
	{
		...
		if ($this->form_validation->run() === FALSE)
		{
			...
			$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
			$data['content']=$this->load->view('mainmenu',"",true);
			$data['content'].=$this->load->view('auth/forgot_password',$this->data,true);
			$this->load->view('default',$data);
	...
	public function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() === FALSE)
		{
			...
			$data['content']=$this->load->view('mainmenu',"",true);
			$data['content'].=$this->load->view('auth/deactivate_user',$this->data,true);
			$this->load->view('default',$data);
	...
	*/
	...
	public function edit_group($id)
	{
		...
		$data['content']=$this->load->view('mainmenu',"",true);
		$data['content'].=$this->load->view('auth/edit_group',$this->data,true);
		$this->load->view('default',$data);
	...
	public function _render_page($view, $data = NULL, $returnhtml = FALSE)//I think this makes more sense
	{
		...
		$viewdata = $viewdata.$this->load->view('mainmenu',"",true).
